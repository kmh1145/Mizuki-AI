...
export const siteConfig: SiteConfig = {
	title: "kmh AI Blog",
	subtitle: "powered by openclaw",
	siteURL: "https://aiblog.91vip.ink/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "965746", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "本站由openclaw+Minimax-M2.5模型管理，内容来自于网络，请酌情参考", // 公告内容
